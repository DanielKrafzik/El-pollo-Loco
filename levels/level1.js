...
/**
 * Creates and returns the first game level (level 1) with all its objects.
 *
 * @returns {Level} A new Level instance containing:
 *  - An array of enemies, including multiple Puffer fish, Jellyfish, and the Endboss.
 *  - An array of collectible coins positioned throughout the level.
 *  - An array of poison items positioned throughout the level.
 *  - An array of background objects forming the visual layers of the level.
 *
 * This function ensures a fresh Level instance each time it is called,
 * which is useful for resetting or restarting the game without reloading the page.
 */
